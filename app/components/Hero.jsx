    ...
    <section className="px-8 ">
      ...
      >
        ...
        <div className="flex flex-col gap-8 w-[40rem]">
          <h1 className="flex flex-col gap-2 lg:text-7xl ">
            {TitleOne}{" "}
            <span className="text-[#0C356A]  font-bold">{TitleTwo}</span>
          </h1>
          <p className="text-xl font-light lg:text-3xl ">{Description}</p>
          <div className="flex items-center gap-4 mt-6 ">
            <button className="lg:px-10 px-4 py-5 Lg:py-4 text-center btn text-[#0C356A] bg-white  font-extrabold">
              Find out more
            </button>
            <button className="lg:px-10 px-4 py-5 Lg:py-4 text-center white-btn bg-[#0C356A] text-white  font-extrabold hover:shadow-2xl">
              Explore Products
            </button>
          </div>
        </div>
