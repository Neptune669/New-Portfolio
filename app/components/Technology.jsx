...
const Technology = () => {
  return (
    <section className="flex px-8 mx-auto bg-white rounded-bl-lg max-w-7xl">
      <div className="flex flex-col gap-6 w-fit ">
        ...
        <div className="grid grid-cols-3 ">
          <ul className="flex flex-col gap-6 border-r  border-[#0000002b] w-48 ">
          ...
          <ul className="flex flex-col gap-6 px-3 border-r justify-center items-center border-[#0000002b] w-48 ">
